...
export const ProductCard = ({ product, translate }) => {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 h-full w-full opacity-0 group-hover/product:opacity-80 dark:bg-black pointer-events-none"></div>
      <h2 className="absolute bottom-4 left-4 opacity-0 group-hover/product:opacity-100 dark:text-white">
        {product.title}
      </h2>
    </motion.div>
  );
